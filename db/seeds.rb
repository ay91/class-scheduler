...
c1 = Course.create(name: "Bahasa Malaysia 200: Bahasa Jiwa Bangsa", credit: 2, student_id: 1)
...
c2 = Course.create(name: "Computer Science 215: Software Engineering", credit: 3, student_id: 1)
...
c3 = Course.create(name: "Math 221: Linear Algebra", credit: 3, student_id: 1)
Slot.create(day: 0, start_time: '1970-01-01 17:30:00', end_time: '1970-01-01 18:30:00', course_id: c3.id)
Slot.create(day: 0, start_time: '1970-01-01 17:30:00', end_time: '1970-01-01 18:30:00', course_id: c3.id)

c4 = Course.create(name: "Computer Science 201: Data Structures", credit: 3, student_id: 1)
...
c5 = Course.create(name: "Computer Science 220: Algorithms", credit: 3, student_id: 1)
...
c6 = Course.create(name: "Computer Science 250: Introduction to Website Design", credit: 4, student_id: 1)
...
c7 = Course.create(name: "Math 220: Differential Equations", credit: 3, student_id: 1)
...
c8 = Course.create(name: "English 201: Introduction to Literature", credit: 3, student_id: 1)
...
c9 = Course.create(name: "English 201: Introduction to Literature", credit: 2, student_id: 1)
...
c10 = Course.create(name: "Badminton 101: Learning to Beat Chong Wei", credit: 1, student_id: 1)
